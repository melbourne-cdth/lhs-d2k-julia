...
So in addition to identifying the __stuff__ that is __potential__ information, we need to identify the other __stuff__---the metadata__that will turn that __data stuff__ into information.

## Example

Here are some actual data from my last blood pressure measurement. 
...
1. Which data (datum) would you label as the primary data?
1. What data would you label as metadata?
1. What data are missing/must be inferred  by you?
...
md"""### What are some of the ways we can interpret these data?
